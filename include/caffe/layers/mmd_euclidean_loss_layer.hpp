#ifndef CAFFE_MMD_EUCLIDEAN_LOSS_LAYER_HPP_
#define CAFFE_MMD_EUCLIDEAN_LOSS_LAYER_HPP_
...
class MMDEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit MMDEuclideanLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "MMDEuclideanLoss"; }
  /**
...
#endif  // CAFFE_MMD_EUCLIDEAN_LOSS_LAYER_HPP_
