...
#include "caffe/layers/mmd_euclidean_loss_layer.hpp"

namespace caffe {

template <typename Dtype>
void MMDEuclideanLossLayer<Dtype>::Reshape(
...
template <typename Dtype>
void MMDEuclideanLossLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
#ifdef CPU_ONLY
STUB_GPU(MMDEuclideanLossLayer);
#endif

INSTANTIATE_CLASS(MMDEuclideanLossLayer);
REGISTER_LAYER_CLASS(MMDEuclideanLoss);
