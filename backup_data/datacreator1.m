...
DA_All = getData(all_subjects(DA_list+1), 100);
T_All = getData(all_subjects(T_list+1), 100);
...
len_t_tenth = idivide(len_t, int32(10), 'floor');
...
T_train_da.data = T_train.data(:,:,:,1:len_t_tenth);
T_train_da.label = T_train.label(:,1:len_t_tenth);
T_train_da.headpose = T_train.headpose(:,1:len_t_tenth);

T_train_rest.data = T_train.data(:,:,:,len_t_tenth+1:end);
T_train_rest.label = T_train.label(:,len_t_tenth+1:end);
T_train_rest.headpose = T_train.headpose(:,len_t_tenth+1:end);
...
sigma_data = sigma_data/(len_da^2);
sigma_headpose = sigma_headpose/(len_da^2);
...
filename = strcat('DAG_weighted_', int2str(DA_list(1)), '_', int2str(DA_list(2)), '_', int2str(DA_list(3)), '_', int2str(DA_list(4)), '_TS_', int2str(T_list(1)), '.h5');
fprintf(fileID, '%s\n', strcat(pth, filename));
...
filename = strcat('T_train_da_', 'TS_', int2str(T_list(1)), '.h5');
fprintf(fileID, '%s\n', strcat(pth, filename));
...
filename = strcat('T_train_rest_', 'TS_', int2str(T_list(1)), '.h5');
fprintf(fileID, '%s\n', strcat(pth, filename));
