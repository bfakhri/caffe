#!/bin/sh
~/Gaze/bijcaffe/build/tools/caffe train -solver ~/Gaze/bijcaffe/testing_da/t1_b/solver.prototxt
...
~/Gaze/bijcaffe/build/tools/caffe test -model ~/Gaze/bijcaffe/testing_da/t1_b/cnn.prototxt -weights ~/Gaze/bijcaffe/testing_da/t1/trained_nets/_iter_10000.caffemodel
